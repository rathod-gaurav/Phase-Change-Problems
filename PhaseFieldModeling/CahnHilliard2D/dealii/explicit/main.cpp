...
void generate_grid(Triangulation<2>& triangulation){
    ...
    grid_out.write_gnuplot(triangulation, "mesh.gnuplot"); //write the triangulation to a vtu file
...
void distribute_dofs(DofHandler<2> &dof_handler){
    ...
    dof_handler.distribute_dofs(finite_element); //we first create a object of FE_Q class and pass it on to the DofHandler object to allocate storage for the degrees of freedom
