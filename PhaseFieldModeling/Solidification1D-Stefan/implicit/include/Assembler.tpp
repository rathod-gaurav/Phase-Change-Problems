...
void Assembler<Nsd,Nne,BfOrder>::assembleSystem_phi(
    ...
    Dphiphi = Eigen::MatrixXd::Zero(Nt,Nt);
    DphiT = Eigen::MatrixXd::Zero(Nt,Nt);
    ...
    Eigen::MatrixXd Dphiphi_e = Eigen::MatrixXd::Zero(Nne,Nne);
    Eigen::MatrixXd DphiT_e = Eigen::MatrixXd::Zero(Nne,Nne);
    ...
    for(unsigned int e = 0 ; e < Nel_t ; e++){
        ...
        Dphiphi.block(Aglobal_e,Aglobal_e,Nne,Nne) += Dphiphi_e;
        DphiT.block(Aglobal_e,Aglobal_e,Nne,Nne) += DphiT_e;
    }
}
...
void Assembler<Nsd,Nne,BfOrder>::assembleSystem_T(
    ...
    DTphi = Eigen::MatrixXd::Zero(Nt,Nt);
    ...
    Eigen::MatrixXd DTphi_e = Eigen::MatrixXd::Zero(Nne,Nne);
    ...
    for(unsigned int e = 0 ; e < Nel_t ; e++){
        ...
        DTphi.block(Aglobal_e,Aglobal_e,Nne,Nne) += DTphi_e;
    }
}
